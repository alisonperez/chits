...
function connect($host='localhost',$username='$_SESSION["dbuser"]',$passwd='$_SESSION["dbpass"]',$db='$_SESSION["dbname"]'){
    $this->conn = mysql_connect("localhost",$username,$passwd) or die( mysql_error() );
...
function mysql_report($query,$dump=false,$attr=array(),$file){
