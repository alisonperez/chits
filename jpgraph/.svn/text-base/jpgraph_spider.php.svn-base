...
// Ver:		$Id: jpgraph_spider.php,v 1.17 2002/07/01 17:26:27 aditus Exp $
//
...
// PUBLIC METHODS
    function SupressTickMarks($f=true) {
    	if( ERR_DEPRECATED )
    		JpGraphError::Raise('SpiderGraph::SupressTickMarks() is deprecated. Use HideTickMarks() instead.');
