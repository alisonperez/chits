...
class consult_report extends module {
    ...
    function init_sql() {
        ...
        module::execsql("CREATE TABLE `m_consult_report_dailyservice` (".
            ...
            "`patient_bgy` float NOT NULL default '0',".
	...
	module::execsql("ALTER table `m_consult_report_dailyservice` modify column `philhealth_id` varchar(50) ".
	    "NOT NULL default '';");
	module::execsql("ALTER table `m_consult_ccdev_report_dailyservice` modify column `philhealth_id` varchar(50) ".
	    "NOT NULL default '';");
	module::execsql("ALTER table `m_consult_mc_report_dailyservice` modify column `philhealth_id` varchar(50) ".
	    "NOT NULL default '';");
    }
	...
	if ($result = mysql_query($sql)) {
		...
		while (list($pid,$pname,$sex,$age,$addr,$bgy,$fid,$phid,$cc,$dx,$tx) = mysql_fetch_array($result)) {
		    ...
		    Wt: $res_vitals[vitals_weight] kg,Temp: $res_vitals[vitals_temp]</td>"; // display the vital signs
    ...
    function display_form_summary_date() {
        ...
        print "<a href='../modules/_uploads/consult_reg.pdf' target='_blank'>DAILY SERVICE - CONSULTS</a><br/>";
        print "<a href='../modules/_uploads/consult_ccdev_reg.pdf' target='_blank'>DAILY SERVICE - CHILD CARE SERVICES</a><br/>";
        print "<a href='../modules/_uploads/consult_mc_reg.pdf' target='_blank'>DAILY SERVICE - MATERNAL CARE SERVICES</a><br/>";
    }
