...
//		print_r($bilang);
	...
	function process_prenatal(){
		...
		if($_SESSION[brgy]=='all'):		
			...
			$check_query = mysql_query("SELECT a.patient_id,b.prenatal_date, a.mc_id FROM m_patient_mc a,m_consult_mc_prenatal b where a.patient_id=b.patient_id AND a.end_pregnancy_flag='N' AND b.prenatal_date BETWEEN '$_SESSION[sdate]' AND '$_SESSION[edate]' ORDER by b.prenatal_date ASC") or die(mysql_error());			
