<?
class ccdev_report extends module {

    // Author: Herman Tolentino MD
    // CHITS Project 2004

    function ccdev_report() {
        //
        // do not forget to update version
        //
        $this->author = 'Herman Tolentino MD';
        $this->version = "0.2-".date("Y-m-d");
        $this->module = "ccdev_report";
        $this->description = "CHITS Module - CCDEV Report";
    }
    ...
    //
        module::set_lang("FTITLE_CCDEV_REPORTS", "english", "CHILD CARE & DEVELOPMENT REPORTS", "Y");
    ...
    function init_menu() {
        ...
        // menu entries
        module::set_menu($this->module, "CCDEV Reports", "REPORTS", "_ccdev_report");
    ...
    //
        ...
        if ($exitinfo = $this->missing_dependencies('ccdev_report')) {
            return print($exitinfo);
        }
        print "<span class='patient'>".FTITLE_CCDEV_REPORTS."</span><br/><br/>";
        $c = new CCDEV_report;
        $g = new graph;
